...
model1 = keras.models.load_model('C:\\Users\\dgmis\\Desktop\\IIT Mandi\\India Today\\eyewear_app\\parent_label')
...
image_data=np.load('parent_data.npy',allow_pickle=True)
